...
const fields = [
  {
    ...
    // Custom date format (date-fns format strings)
    formatConfig: {
      valueFormat: 'yyyy-MM-dd',        // Internal value (API payload)
      displayFormat: 'MMM d, yyyy',     // Display in token (e.g., "Jan 15, 2024")
      // locale: ja,                    // import { ja } from 'date-fns/locale'
    },
  ...
  },
  {
    ...
    operators: ['gt', 'lt'],
    formatConfig: {
      valueFormat: "yyyy-MM-dd'T'HH:mm:ssxxx",  // ISO 8601 with timezone
      displayFormat: 'yyyy-MM-dd HH:mm',        // Display format
      timeDisplayFormat: 'HH:mm',               // Time picker format
    },
...
yarn add https://github.com/KuruwiC/tokenized-search-input/releases/download/v0.1.0/kuruwic-tokenized-search-input-0.1.0.tgz`}
        ...
        <section className="demo-section">
          ...
          <div className="grid gap-4 sm:grid-cols-2 mb-6">
            <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
              <h3 className="font-medium mb-2">allowUnknownFields</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
              <h3 className="font-medium mb-2">unknownFieldOperators</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
