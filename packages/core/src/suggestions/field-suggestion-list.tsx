        ...
        <fieldset key={group.category}>
          ...
          {group.fields.map((field, fieldIndex) => {
            ...
            return (
              ...
              >
                {field.icon && <span className="tsi-field-icon">{field.icon}</span>}
                <span className="tsi-field-label">{field.label}</span>
                {field.hint && <span className="tsi-field-hint">{field.hint}</span>}
                <span className="tsi-field-key">{field.key}</span>
              </div>
            );
          })}
        </fieldset>
